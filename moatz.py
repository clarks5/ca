...
# bot session
api_id_bot = 16557788
api_hash_bot = "29492b0b26613928ea7d2580086e712c"
bot = TelegramClient("Bot", api_id_bot, api_hash_bot).start(bot_token="6964562228:AAEO6j3B4sBNlss8mpM0s1Wt4AAC9boTxQM")
...
async def StartButtons(event, role):
    ...
    await event.reply("__لاضافة رقم اضغط على الزر اسفله لبدأ عملية اضافة الرقم المطور @b_b_f__", buttons=buttons)
